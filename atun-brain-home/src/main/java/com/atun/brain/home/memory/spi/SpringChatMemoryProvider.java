...
@Slf4j
@Component
public class SpringChatMemoryProvider implements ChatMemoryProvider {
    ...
    public SpringChatMemoryProvider(ChatMemoryStore chatMemoryStore, MemoryWindowConfig windowConfig) {

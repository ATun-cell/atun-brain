package com.atun.brain.home.rag.spi;
...
import com.atun.brain.home.rag.config.RagSpiConfig.QdrantProperties;
...
public class QdrantEmbeddingStoreProvider implements EmbeddingStoreProvider {
    ...
    public QdrantEmbeddingStoreProvider(QdrantClient qdrantClient,
                                        ...
                                        @Value("${agent.rag.embedding.dimension:1536}") int vectorSize) {
        this.qdrantClient = qdrantClient;
        this.collectionName = qdrantProperties.getCollection();
    ...
    @PostConstruct
    public void init() {
        initialize(collectionName, vectorSize);
    }
